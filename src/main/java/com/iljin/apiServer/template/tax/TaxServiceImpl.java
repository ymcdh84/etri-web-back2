...
public class TaxServiceImpl implements TaxService{
    ...
    public Map<String, Object> certificateKey(String root) throws Exception {
        ...
        JeTS.installProvider("C:\\SCOREPKI4J-SERVER-3.5.61-DIST\\data\\config\\tradesign3280.properties");
...
//            sig.verify(sigText);
    ...
    public String urlHometaxSchTaxBill(Map pWqInfo) throws Exception {
        ...
        //String schStDt = formatter.format(DateUtils.addDays(DateUtils.addMonths(today, -3),1));//3개월전
        //String schStDt = formatter.format(today);//현재일자
        String schStDt = "20211201";
        ...
        try {
            ...
            for(int i = 0; i < taxCnt; i++){
                ...
                if(conn != null){
                    ...
                    FileOutputStream os = new FileOutputStream(new File(outputDir, etan + ".xml"));
